...
{
	return {
		"name":			"Construct Play Games",			// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"ConstructPlayGames",			// this is used to identify this plugin and is saved to the project; never change it
		...
		"cordova-plugins": "construct-play-games",
...
AddStringParam("Leaderboard ID", "Leaderboard ID to display");
AddAction(11, af_none, "Show native leaderboard dialog", "Leaderboards", "leaderboard <i>{0}</i>", "Display the native google play games dialog a specific leaderboard (Only works in Android app)", "ShowLeaderboard");

AddAction(12, af_none, "Show native leaderboards dialog", "Leaderboards", "Display leaderboards", "Display the native google play games dialog all leaderboards (Only works in Android app)", "ShowLeaderboards");

AddAction(13, af_none, "Show native achievement dialog", "Achievements", "Display achievement", "Display the native google play games dialog all achievements (Only works in Android app)", "ShowAchievements");
